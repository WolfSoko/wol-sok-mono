...
import { BlockPublicAccess, BucketAccessControl, IBucket } from 'aws-cdk-lib/aws-s3';
...
export class Bucket extends Stack {
  ...
  constructor(scope: Construct, id: string, props: BucketProps) {
    ...
    this.bucketRef = new s3.Bucket(this, 'rollAPolla', {
    ...
    new s3deploy.BucketDeployment(this, 'DeployApp', {
      ...
      destinationBucket: this.bucketRef,
    });
  }
}
