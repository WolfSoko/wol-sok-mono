...
export class InfoComponent {
  ...
  public technologies = [
    ...
    new Technology(
      'three.js',
      'https://threejs.org/',
      'assets/logos/three-js.png'
    ),
    new Technology('gpu.js', 'http://gpu.rocks/', 'assets/logos/gpu-js.png'),
    new Technology(
      'Angular Material',
      'http://angular.material.io/',
      'assets/logos/angular-material.svg'
    ),
    new Technology(
      'tensorflow.js',
      'https://js.tensorflow.org',
      'assets/logos/tensorflow-js.png'
    ),
    new Technology(
      'firebase',
  ...
  startDemo(): void {
    ...
    from(this.techCards.toArray())
      .pipe(
        concatMap((techCard) =>
          techCard
            .vaporizeAndScrollIntoView(false)
            .pipe(takeUntil(this.stopSub.asObservable()))
        ),
