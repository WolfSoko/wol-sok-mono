(module
 ...
 (data (i32.const 1084) ",\00\00\00\00\00\00\00\00\00\00\00\01\00\00\00\1a\00\00\00~\00l\00i\00b\00/\00a\00r\00r\00a\00y\00.\00t\00s\00\00\00")
 ...
 (data (i32.const 1536) "\04\00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\02\t\00\00\00\00\00\00")
 (import "env" "abort" (func $~lib/builtins/abort (param i32 i32 i32 i32)))
 (import "index" "logRecCalls" (func $libs/fib-wasm/assembly/index/logRecCalls (param i32)))
 (global $libs/fib-wasm/assembly/index/recCalls (mut i32) (i32.const 0))
 ...
 (global $libs/fib-wasm/assembly/index/memoize (mut i32) (i32.const 0))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 17956))
 (export "logRecCalls" (func $libs/fib-wasm/assembly/index/logRecCalls))
 (export "fib" (func $libs/fib-wasm/assembly/index/fib))
 (export "fibMem" (func $libs/fib-wasm/assembly/index/fibMem))
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $libs/fib-wasm/assembly/index/memoize
  local.tee $0
  if
   local.get $0
 ...
 (func $libs/fib-wasm/assembly/index/fibRec (param $0 i32) (result i32)
  local.get $0
  i32.const 2
  i32.lt_s
  if
  ...
  global.get $libs/fib-wasm/assembly/index/recCalls
  i32.const 1
  i32.add
  global.set $libs/fib-wasm/assembly/index/recCalls
  local.get $0
  i32.const 1
  i32.sub
  call $libs/fib-wasm/assembly/index/fibRec
  local.get $0
  i32.const 2
  i32.sub
  call $libs/fib-wasm/assembly/index/fibRec
 ...
 (func $libs/fib-wasm/assembly/index/fib (param $0 i32) (result i32)
  i32.const 0
  global.set $libs/fib-wasm/assembly/index/recCalls
  local.get $0
  call $libs/fib-wasm/assembly/index/fibRec
  global.get $libs/fib-wasm/assembly/index/recCalls
  call $libs/fib-wasm/assembly/index/logRecCalls
 )
 ...
 (func $~start
  ...
  global.set $~lib/memory/__stack_pointer
  local.get $1
  global.set $libs/fib-wasm/assembly/index/memoize
 )
 (func $libs/fib-wasm/assembly/index/fibRecMem (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  ...
  block $folding-inner0
   ...
   i32.const 1
   i32.sub
   call $libs/fib-wasm/assembly/index/fibRecMem
   local.get $0
   i32.const 2
   i32.sub
   call $libs/fib-wasm/assembly/index/fibRecMem
 ...
 (func $libs/fib-wasm/assembly/index/fibMem (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
