...
export const getPolynomialRegressionTab = () =>
  getTabs().get(`${TABS_LINKS_CLASS}:nth-child(1)`).should('contain.text', ' Polynomial regression ');

export const getLearnedDigitsTab = () =>
  getTabs().get(`${TABS_LINKS_CLASS}:nth-child(2)`).should('contain.text', ' Learned digits (MNIST) ');
